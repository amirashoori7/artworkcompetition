    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.PositiveSmallIntegerField(choices=[(1, 'student'), (2, 'judge1'), (3, 'decisionmaker'), (4, 'judge2'), (5, 'judge3'), (6, 'admin'), (7, 'GMMDC')], default=1, null=True)),
                ('dob', models.CharField(blank=True, max_length=12, null=True)),
                ('cellphone', models.CharField(blank=True, max_length=100, null=True)),
                ('organisation', models.CharField(blank=True, default='', max_length=100, null=True)),
