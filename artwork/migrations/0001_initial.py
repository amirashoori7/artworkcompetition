# Generated by Django 2.2.6 on 2019-12-21 17:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('d1a', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='evaluation.D1A')),
                ('d1b', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='evaluation.D1B')),
                ('d2', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='evaluation.D2')),
                ('d3', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='evaluation.D3')),
